...
| `1:56–2:10` | RDS console (Serverless v2) + CloudWatch ACU graph scaling | *"Real Aurora, real volume, scales up for the recall and back down between. The report lands, and the whole outbreak is on the table."* | End on the live URL + FDA SLA pressure |
